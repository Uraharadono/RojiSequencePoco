...
using Core5ApiBoilerplate.Utility.Helpers;
...
namespace Core5ApiBoilerplate.Controllers.Identity
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginViewModel model)
        {
            ...
            if (await _userManager.CheckPasswordAsync(user, model.Password).ConfigureAwait(false))
            {
                ...
                else
                {
                    ...
                    // JwtSecurityToken jwtSecurityToken = await GenerateAsync(user);
        ...
        private async Task<JwtSecurityToken> CreateJwtToken(ApplicationUser user, bool rememberMe)
        {
            ...
            //var keyByteArray = Encoding.ASCII.GetBytes("LongerThan-16Char-SecretKey");
        ...
        {
            ResetPasswordViewModel testModel = new ResetPasswordViewModel
            {
                UserId = "Mikey user id",
                Code = "Test code",
                Password = "Test code",
                ConfirmPassword = "Test code",
            };
            return Ok(testModel);
        }
    }
